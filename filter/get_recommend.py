...
#获取列表
def get_recommend(shareList):
	# content3='<table border="1" style="font-size:16px;"><tr>  <th>ts_name</th>  <th>ma_tendency</th>  <th>Increase25</th> <th>up2</th>  </tr>'+''+'</table>'
	content3=shareList.iloc[1, 1]
	return content3

def get_recommend2(shareList):
